...
const Title = ({ clientHeight }) => {
  ...
  return (
    <section className="w-full h-[100vh] relative select-none" ref={targetSection}>
      <div
        className={`${clientHeight > 650 ? "py-80" : "py-72"
          } section-container`}
      >
        <h1
          ref={quoteRef}
        ...
        >
          <p className="text-[40px] sm:text-[60px] md:text-[90px] lg:text-[120px]">
            <span className="italic">Together</span>
            <span>, we</span>
          </p>
          <p className="text-[50px] sm:text-[80px] md:text-[100px] lg:text-[140px] flex justify-center">
            <span>pioneer</span>&nbsp;
